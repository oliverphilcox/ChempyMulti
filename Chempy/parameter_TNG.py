...
class ModelParameters(object):
	...
	beta_param = 'not fixed'#1. # This can be set as constant here, or let to vary in the below prior
	...
	parameter_names = [r'$\log_{10}\beta$',r'$\log_{10}\left(\mathrm{N}_\mathrm{Ia}\right)$',r'$\log_{10}(\mathrm{SFE})$',r'$\log_{10}(\mathrm{SFR_{peak}})$',r'\mathrm{x_{out}}']
	...
	starformation_efficiency = 0.#10**-0.3 #0.
	gas_power = 0.
	...
	elements_to_trace = ['C', 'Fe', 'H', 'He', 'N', 'Ne', 'O', 'Si']
	...
	if True:
		#prior
		SSP_parameters =  [1.0,-2.75]#[5.0,-2.29 ,-2.75 ]#,	-0.8 ]#,0.2]#, 0.7, 0.3, 0.0]
		SSP_parameters_to_optimize = ['log10_beta','log10_N_0']#['beta_param', 'high_mass_slope', 'log10_N_0']#, 'log10_sn1a_time_delay']#,'log10_sfr_factor_for_cosmic_accretion']#,'log10_gas_reservoir_mass_factor','log10_a_parameter','log10_gas_power']
	else:
		SSP_parameters = []
	...
	training_widths = [0.6,0.6,0.2,0.2] # 2 sigma widths
