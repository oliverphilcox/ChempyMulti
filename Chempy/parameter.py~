...
class ModelParameters(object):
	...
	stellar_identifier_list = ['Proto-sun_Ba']#['Proto-sun']
	stellar_identifier = 'Proto-sun_Ba'#'Proto-sun'

	## FOR Ba TEST!! - also remove in element list!
	...
	# 28 elements	
	element_names = ['He', 'C', 'N', 'O', 'F','Ne','Na', 'Mg', 'Al', 'Si', 'P','S', 'Cl','Ar','K', 'Ca','Sc','Ti', 'V', 'Cr', 'Mn', 'Fe', 'Co', 'Ni','Cu','Zn','Ga','Ge','Ba']#, 'Zn','Y', 'Ba']# Runs with sun
	
	elements_to_trace = ['Al', 'Ar', 'B', 'Ba', 'Be', 'C', 'Ca', 'Cl', 'Co', 'Cr', 'Cu', 'F', 'Fe', 'Ga', 'Ge', 'H', 'He', 'K', 'Li', 'Mg', 'Mn', 'N', 'Na', 'Ne', 'Ni', 'O', 'P', 'S', 'Sc', 'Si', 'Ti', 'V', 'Zn']
