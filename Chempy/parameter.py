...
class ModelParameters(object):
    ...
    yield_table_name_sn2_index = 8#4#8#9
    ...
    yield_table_name_agb_index = 5#4#5#4
    ...
    yield_table_name_1a_index = 3#2#3#2
    ...
    ISM_parameters =  [-0.3,0.55,0.5,0.5]#,0.3,0.]#, 0.3,0.2, 0.7, 0.3, 0.0]
    ISM_parameters_to_optimize = ['log10_starformation_efficiency', 'log10_sfr_scale', 'outflow_feedback_fraction','log10_gas_reservoir_mass_factor']#,'log10_sfr_factor_for_cosmic_accretion']#,'log10_sfr_factor_for_cosmic_accretion','log10_a_parameter','log10_gas_power']
