...
#define __PYX_HAVE__Chempy__CyChempy
#define __PYX_HAVE_API__Chempy__CyChempy
#include <string.h>
#include <stdio.h>
#include <stdlib.h>
...
/* Module declarations from 'Chempy.CyChempy' */
#define __Pyx_MODULE_NAME "Chempy.CyChempy"
int __pyx_module_is_main_Chempy__CyChempy = 0;

/* Implementation of 'Chempy.CyChempy' */
...
static const char __pyx_k_c_gauss[] = "c_gauss";
static const char __pyx_k_ValueError[] = "ValueError";
static const char __pyx_k_ImportError[] = "ImportError";
static const char __pyx_k_RuntimeError[] = "RuntimeError";
static const char __pyx_k_Chempy_CyChempy[] = "Chempy.CyChempy";
static const char __pyx_k_ndarray_is_not_C_contiguous[] = "ndarray is not C contiguous";
static const char __pyx_k_home_philcox_Chempy_Chempy_CyCh[] = "/home/philcox/Chempy/Chempy/CyChempy.pyx";
...
static PyObject *__pyx_n_s_Chempy_CyChempy;
...
static PyObject *__pyx_n_s_c_gauss;
static PyObject *__pyx_n_s_err;
static PyObject *__pyx_kp_s_home_philcox_Chempy_Chempy_CyCh;
...
static PyObject *__pyx_pf_6Chempy_8CyChempy_c_gauss(CYTHON_UNUSED PyObject *__pyx_self, CYTHON_UNUSED PyObject *__pyx_v_err, CYTHON_UNUSED PyObject *__pyx_v_x, CYTHON_UNUSED PyObject *__pyx_v_mu); /* proto */
...
/* "Chempy/CyChempy.pyx":2
 * cimport numpy as np
 * def c_gauss(list err, list x, list mu):             # <<<<<<<<<<<<<<
 * 	"""
 * 	Cython function to compute gaussian
 */

/* Python wrapper */
static PyObject *__pyx_pw_6Chempy_8CyChempy_1c_gauss(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static char __pyx_doc_6Chempy_8CyChempy_c_gauss[] = "\n\tCython function to compute gaussian\n\t";
static PyMethodDef __pyx_mdef_6Chempy_8CyChempy_1c_gauss = {"c_gauss", (PyCFunction)__pyx_pw_6Chempy_8CyChempy_1c_gauss, METH_VARARGS|METH_KEYWORDS, __pyx_doc_6Chempy_8CyChempy_c_gauss};
static PyObject *__pyx_pw_6Chempy_8CyChempy_1c_gauss(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  CYTHON_UNUSED PyObject *__pyx_v_err = 0;
  CYTHON_UNUSED PyObject *__pyx_v_x = 0;
  CYTHON_UNUSED PyObject *__pyx_v_mu = 0;
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("c_gauss (wrapper)", 0);
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_err,&__pyx_n_s_x,&__pyx_n_s_mu,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_x)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("c_gauss", 1, 3, 3, 1); __PYX_ERR(0, 2, __pyx_L3_error)
        }
        case  2:
        if (likely((values[2] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_mu)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("c_gauss", 1, 3, 3, 2); __PYX_ERR(0, 2, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "c_gauss") < 0)) __PYX_ERR(0, 2, __pyx_L3_error)
      }
    ...
    __pyx_v_err = ((PyObject*)values[0]);
    __pyx_v_x = ((PyObject*)values[1]);
    __pyx_v_mu = ((PyObject*)values[2]);
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("c_gauss", 1, 3, 3, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 2, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("Chempy.CyChempy.c_gauss", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_err), (&PyList_Type), 1, "err", 1))) __PYX_ERR(0, 2, __pyx_L1_error)
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_x), (&PyList_Type), 1, "x", 1))) __PYX_ERR(0, 2, __pyx_L1_error)
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_mu), (&PyList_Type), 1, "mu", 1))) __PYX_ERR(0, 2, __pyx_L1_error)
  __pyx_r = __pyx_pf_6Chempy_8CyChempy_c_gauss(__pyx_self, __pyx_v_err, __pyx_v_x, __pyx_v_mu);
...
static PyObject *__pyx_pf_6Chempy_8CyChempy_c_gauss(CYTHON_UNUSED PyObject *__pyx_self, CYTHON_UNUSED PyObject *__pyx_v_err, CYTHON_UNUSED PyObject *__pyx_v_x, CYTHON_UNUSED PyObject *__pyx_v_mu) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("c_gauss", 0);

  /* "Chempy/CyChempy.pyx":7
 * 	"""
 * 	#cpdef list result = 0.3989422804014327 / err * np.exp(-(x-mu)*(x-mu)/(2*err))
 * 	return 0 ##result             # <<<<<<<<<<<<<<
 * 
 */
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  {&__pyx_n_s_Chempy_CyChempy, __pyx_k_Chempy_CyChempy, sizeof(__pyx_k_Chempy_CyChempy), 0, 0, 1, 1},
  ...
  {&__pyx_n_s_c_gauss, __pyx_k_c_gauss, sizeof(__pyx_k_c_gauss), 0, 0, 1, 1},
  {&__pyx_n_s_err, __pyx_k_err, sizeof(__pyx_k_err), 0, 0, 1, 1},
  {&__pyx_kp_s_home_philcox_Chempy_Chempy_CyCh, __pyx_k_home_philcox_Chempy_Chempy_CyCh, sizeof(__pyx_k_home_philcox_Chempy_Chempy_CyCh), 0, 0, 1, 0},
 ...
 * 	Cython function to compute gaussian
 */
  __pyx_tuple__10 = PyTuple_Pack(3, __pyx_n_s_err, __pyx_n_s_x, __pyx_n_s_mu); if (unlikely(!__pyx_tuple__10)) __PYX_ERR(0, 2, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__10);
  __Pyx_GIVEREF(__pyx_tuple__10);
  __pyx_codeobj__11 = (PyObject*)__Pyx_PyCode_New(3, 0, 3, 0, 0, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__10, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_home_philcox_Chempy_Chempy_CyCh, __pyx_n_s_c_gauss, 2, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__11)) __PYX_ERR(0, 2, __pyx_L1_error)
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
...
#if PY_MAJOR_VERSION < 3
PyMODINIT_FUNC initCyChempy(void); /*proto*/
PyMODINIT_FUNC initCyChempy(void)
#else
PyMODINIT_FUNC PyInit_CyChempy(void); /*proto*/
PyMODINIT_FUNC PyInit_CyChempy(void)
#endif
{
  PyObject *__pyx_t_1 = NULL;
  __Pyx_RefNannyDeclarations
  ...
  #endif
  __Pyx_RefNannySetupContext("PyMODINIT_FUNC PyInit_CyChempy(void)", 0);
  ...
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("CyChempy", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_Chempy__CyChempy) {
    if (PyObject_SetAttrString(__pyx_m, "__name__", __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "Chempy.CyChempy")) {
      if (unlikely(PyDict_SetItemString(modules, "Chempy.CyChempy", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 * 	Cython function to compute gaussian
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_6Chempy_8CyChempy_1c_gauss, NULL, __pyx_n_s_Chempy_CyChempy); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 2, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_c_gauss, __pyx_t_1) < 0) __PYX_ERR(0, 2, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;

  /* "Chempy/CyChempy.pyx":1
 * cimport numpy as np             # <<<<<<<<<<<<<<
 * def c_gauss(list err, list x, list mu):
 * 	"""
 */
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init Chempy.CyChempy", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init Chempy.CyChempy");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if PY_MAJOR_VERSION < 3
