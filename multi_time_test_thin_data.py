...
widths = np.asarray([0.6, 0.6, 0.6, 0.2, 0.2])/2. # prior widths used to generate training data
...
for i in range(len(all_params)):
    ...
    all_params[i,5]=uniform.rvs(loc=2.0,scale=11.5)
print("Create %d-element parameter set."%N_samples)
...
if __name__=='__main__':
    ...
    # Now save output
    np.savez("Variable_Time_Test_Thin_Predictions.npz",abundances=abuns,elements=els,params=pars);
