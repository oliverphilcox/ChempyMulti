...
## Getting started
The jupyter [tutorial](https://github.com/oliverphilcox/Chempy/tree/master/tutorials) illustrates the basic usage of Chempy and basic concepts of galactic chemical evolution modeling. It can be inspected in the github repository or you can run it interactively on your local machine. Tutorial for yield table scoring is found [here](https://github.com/oliverphilcox/ChempyScoring/blob/master/Scoring%20%26%20Parameter%20Choice%20Tutorial.ipynb)
...
You can also have a look at the *preliminary* Chempy [documentaion](http://www.mpia.de/homes/rybizki/html/index.html) which gives an overview over the Chempy classes and functions.

## Attribution
Please cite the initial Chempy [paper](https://arxiv.org/abs/1702.08729) and scoring table updates (Philcox & Rybizki 2017, in prep.) when using the code in your research (so far only arxiv link, will be updated).
